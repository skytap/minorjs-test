...
module.exports = Mock = {
    ...
    switch (typeof options.fixture) {
      ...
      case 'string':
        ...
        if (fs.existsSync(filePathJson)) {
          ...
          fixtureFile = extend(true, {}, require(filePathJson));
          return result.reply(status, fixtureFile, {'Content-Type': 'application/json'});
  ...
  _mockOne : function (url, options, allowUnmocked) {
    ...
    result = result.intercept(queryPath, options.method || 'get', options.body || undefined);
